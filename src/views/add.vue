    ...
    <div v-if="!MostrarSpinner">
      <div >
        ...
        <div class="container-sm shadow p-3  bg-white" style="max-width: 1300px; ">
          ...
          <div class="row " >
          <div class="col-1" >
            <v-text-field v-model="Identificador" label="Identificador" variant="underlined" block></v-text-field>
          </div>
          <div class="col-2" >
        ...
        <div class="row" >
          <div class="col-2" >
            <v-text-field  v-model="NCompribante"   label="Nro Comprobante" variant="underlined" block></v-text-field>
          </div>
          <div class="col-2" >
...
<div class="row" >
              <div class="col-4 text-center ">
                ...
                <v-text-field  v-model="MedCodigo" label="Dosis" variant="underlined" block></v-text-field>
              </div>
              <div class="col-6 text-center ">
              ...
              <div class="col-1 text-center "> 
                <v-text-field  v-model="MedPrecio" label="Cantidad"  variant="underlined" block></v-text-field>
              </div>
              <div class="col-1 text-center "> 
