<template class=" text-center">
  <v-card  class="px-4 py-2  text-center w-100" elevation="16"  style="height: 100%;">
    <v-card>
      <v-layout>
        ...
        >
          ...
          <v-toolbar-title><v-chip class="d-flex  darken-1 sm text-h5 text-center"  color="#000000" elevation="1"   >  <b>SISTEMA DE MEDICAMENTOS</b></v-chip></v-toolbar-title>
    ...
    <div class="card border border-4  mx-auto   shadow-lg p-1 mb-2" style="max-width: 650px; margin-bottom: 5%; margin-top: 5%" >
    ...
    <b> Acceso al sistema</b>
      ...
      <div class="row" >
              <div class="col  p-3 text-center "><img :src="require('../assets/LogoExc_Chico.png')" style="max-width: 100%; margin-bottom: 0%; margin-top: 1%"  /></div>
